...
def arg_parse():
    ...
    parser.add_argument('--victim', default='supcon', choices=['simclr', 'byol', 'barlow_twins', 'deepclusterv2', 'dino', 'mocov3', 'mocov2plus', 'nnclr', 'ressl', 'supcon', 'swav', 'vibcreg', 'vicreg', 'wmse'])
...
def uap_dcgan_attack(args, train_loader, test_loader, model):
    ...
    for epoch in range(args.epochs):
        ...
        # save uap result
        uap_save_path = os.path.join('./advencoder', str(args.pre_dataset), 'uap_results', 'gan_per', str(args.victim), str(args.dataset),
