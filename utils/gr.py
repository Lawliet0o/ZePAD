...
def genetic_regularization(adv_results, ben_results, y, sample_weight=0, eps=0.0000001):
    ...
    # target_distance=np.float64(target_distance)
    ...
    # print(torch.sum(model_similarity, dim=1, keepdim=True))
    # print(torch.sum(target_similarity, dim=1, keepdim=True))
