...
from models.triple_model import triple_model
def arg_parse():
    ...
    parser.add_argument('--helper',type=str,default='simclr')
    parser.add_argument('--confidence',type=str,default='zepad')
...
def classify(args, encoder, F, uap):
    ...
    print('Top1 test acc: %.4f, Top1 Adv_test acc: %.4f, Attack success rate: %.4f'
...
def main():
    ...
    print('Benign test accuracy: %.4f%%'% (clean_acc_t1))
    print('Adv test accuracy: %.4f%%'% (adv_acc_t1))
